...
export default function Card({ src, alt, id }) {
  return (
    <div className=" sm:w-[200px] sm:h-[300px] w-[100px] h-[150px] hover:scale-110  ease-in-out transition-all duration-500 rounded-md overflow-hidden border border-white group relative">
